    ...
    <>
      <div className='col-sm-6 col-lg-4'>
        <div className='overview-element mb25 d-flex align-items-center'>
          <span className='icon flaticon-bed !leading-[55px] dark:text-white' />
          <div className='ml15'>
      ...
      <div className='col-sm-6 col-lg-4'>
        <div className='overview-element mb25 d-flex align-items-center'>
          <span className='icon flaticon-shower !leading-[55px] dark:text-white' />
          <div className='ml15'>
      ...
      <div className='col-sm-6 col-lg-4'>
        <div className='overview-element mb25 d-flex align-items-center'>
          <span className='icon flaticon-event !leading-[55px] dark:text-white' />
          <div className='ml15'>
      ...
      <div className='col-sm-6 col-lg-4'>
        <div className='overview-element mb25-xs d-flex align-items-center'>
          <span className='icon flaticon-garage !leading-[55px] dark:text-white' />
          <div className='ml15'>
      ...
      <div className='col-sm-6 col-lg-4'>
        <div className='overview-element mb25-xs d-flex align-items-center'>
          <span className='icon flaticon-expand !leading-[55px] dark:text-white' />
          <div className='ml15'>
      ...
      <div className='col-sm-6 col-lg-4'>
        <div className='overview-element d-flex align-items-center'>
          <span className='icon flaticon-home-1 !leading-[55px] dark:text-white' />
          <div className='ml15'>
