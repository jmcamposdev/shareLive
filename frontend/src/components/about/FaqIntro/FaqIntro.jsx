                  ...
                  <div className='list-one mb30 group'>
                    <span className='dark:!hidden list-icon flex-shrink-0 mb20 items-center justify-center group-hover:!bg-orangePrimary !bg-orangePrimaryLight' style={{ display: 'flex' }}>
                      <svg fill='none' width='30' height='30' viewBox='0 0 16 14' xmlns='http://www.w3.org/2000/svg'>
                        <path className='stroke-black group-hover:stroke-white transition-all duration-400 ease' d='M8.9101 1.51106L7.84998 2.57717L6.78986 1.52004C6.12216 0.938605 5.25866 0.632268 4.37381 0.66292C3.48896 0.693572 2.64872 1.05893 2.02285 1.68518C1.39699 2.31143 1.03214 3.15188 1.00202 4.03675C0.971909 4.92162 1.27877 5.78493 1.86061 6.45229L2.92073 7.5124L5.39135 9.98302L7.84998 12.4596L10.3206 9.98901L12.7912 7.51839L13.8393 6.45229C14.4713 5.79231 14.8197 4.91106 14.8098 3.99735C14.7999 3.08363 14.4325 2.21014 13.7864 1.56401C13.1403 0.917876 12.2668 0.550508 11.3531 0.540611C10.4393 0.530713 9.55809 0.879075 8.89812 1.51106H8.9101Z' strokeWidth='0.8' />
                      </svg>
                    </span>
                    <span className='transition-all duration-400 ease bg-midnight dark:flex hidden group-hover:bg-orangePrimary rounded-full w-[70px] h-[70px] flex-shrink-0 mb20 items-center justify-center'>
                      <svg fill='none' width='30' height='30' viewBox='0 0 16 14' xmlns='http://www.w3.org/2000/svg'>
                        <path className='stroke-white transition-all duration-400 ease' d='M8.9101 1.51106L7.84998 2.57717L6.78986 1.52004C6.12216 0.938605 5.25866 0.632268 4.37381 0.66292C3.48896 0.693572 2.64872 1.05893 2.02285 1.68518C1.39699 2.31143 1.03214 3.15188 1.00202 4.03675C0.971909 4.92162 1.27877 5.78493 1.86061 6.45229L2.92073 7.5124L5.39135 9.98302L7.84998 12.4596L10.3206 9.98901L12.7912 7.51839L13.8393 6.45229C14.4713 5.79231 14.8197 4.91106 14.8098 3.99735C14.7999 3.08363 14.4325 2.21014 13.7864 1.56401C13.1403 0.917876 12.2668 0.550508 11.3531 0.540611C10.4393 0.530713 9.55809 0.879075 8.89812 1.51106H8.9101Z' strokeWidth='0.8' />
                      </svg>
                    </span>
