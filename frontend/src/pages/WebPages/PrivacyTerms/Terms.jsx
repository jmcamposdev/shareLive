...
import TermsImg from '../../../assets/img/terms/terms.jpg'
const TermsConditions = () => {
  return (
    <WebLayout>
      <PageIntro title='Terms & Conditions' description='Learn about our Terms & Conditions' backgroundImage={TermsImg} />
        ...
        <div className='container mx-auto sm:px-4 pt-20'>
          <div className='flex flex-wrap  aos-init aos-animate' data-aos='fade-left' data-aos-delay='300'>
            <div className='container mx-auto py-8'>
              <h1 className='text-3xl font-bold mb-4 dark:text-white'>Welcome to ShareLive Terms & Conditions</h1>
              <h2 className='text-xl font-bold mb-2 dark:text-white'>1. Introduction</h2>
              ...
              <h2 className='text-xl font-bold mb-2 dark:text-white'>2. Identifying Purposes</h2>
              ...
              <h2 className='text-xl font-bold mb-2 dark:text-white'>3. General Conditions</h2>
              <p className='mb-8 dark:text-white'>
                We reserve the right to refuse service to anyone, at any time, for any reason. We reserve the right to make any modifications to the website, including terminating, changing, suspending or discontinuing any aspect of the website at any time, without notice. We may impose additional rules or limits on the use of our website. You agree to review the Terms regularly and your continued access or use of our website will mean that you agree to any changes.
              </p>

              <h2 className='text-xl font-bold mb-2 dark:text-white'>4. Products or Services </h2>
              <p className='mb-4 dark:text-white'>
              ...
              <h2 className='text-xl font-bold mb-2 dark:text-white'>5. Links to Third-Party Websites </h2>
              <p className='mb-8 dark:text-white'>
              ...
              <h2 className='text-xl font-bold mb-2 dark:text-white'>6. Use Comments, Feedback, and Other Submissions </h2>
              <p className='mb-4 dark:text-white'>
              ...
              <h2 className='text-xl font-bold mb-2 dark:text-white'>7. Your Personal Information </h2>
              <p className='mb-8 dark:text-white'>
                Please see our Privacy Policy to learn about how we collect, use, and share your personal information.
              </p>

              <h2 className='text-xl font-bold mb-2 dark:text-white'>8. Errors and Omissions</h2>
              <p className='mb-4 dark:text-white'>
              ...
              <h2 className='text-xl font-bold mb-2 dark:text-white'>9. Disclaimer and Limitation of Liability</h2>
              <p className='mb-4 dark:text-white'>
              ...
              <h2 className='text-xl font-bold mb-2 dark:text-white'>10. Indemnification </h2>
              <p className='mb-8 dark:text-white'>
              ...
              <h2 className='text-xl font-bold mb-2 dark:text-white'>11. Entire Agreement
              </h2>
              <p className='mb-8 dark:text-white'>
                The Terms and any documents expressly referred to in them represent the entire agreement between you and us in relation to the subject matter of the Terms and supersede any prior agreement, understanding or arrangement between you and us, whether oral or in writing. Both you and we acknowledge that, in entering into these Terms, neither you nor we have relied on any representation, undertaking or promise given by the other or implied from anything said or written between you and us prior to such Terms, except as expressly stated in the Terms.
              </p>

              <h2 className='text-xl font-bold mb-2 dark:text-white'>12. Waiver
              </h2>
              <p className='mb-8 dark:text-white'>
                Our failure to exercise or enforce any right or provision of the Terms will not constitute a waiver of such right or provision. A waiver by us of any default will not constitute a waiver of any subsequent default. No waiver by us is effective unless it is communicated to you in writing.
              </p>

              <h2 className='text-xl font-bold mb-2 dark:text-white'>13. Headings</h2>
              <p className='mb-8 dark:text-white'>
                Any headings and titles herein are for convenience only.
              </p>

              <h2 className='text-xl font-bold mb-2 dark:text-white'>14. Severability</h2>
              <p className='mb-8 dark:text-white '>
                If any of the provisions of the Terms are determined by any competent authority to be invalid, unlawful or unenforceable, such provision will to that extent be severed from the remaining Terms, which will continue to be valid and enforceable to the fullest extent permitted by law.
              </p>

              <h2 className='text-xl font-bold mb-2 dark:text-white'>15. Governing Law</h2>
              <p className='mb-4 dark:text-white'>
              ...
              <h2 className='text-xl font-bold mb-2 dark:text-white'>16. Questions or Concerns</h2>
              <p className='mb-8 dark:text-white'>
