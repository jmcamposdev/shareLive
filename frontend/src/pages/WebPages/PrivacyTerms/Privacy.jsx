            ...
            <section className='our-compare pt-20 pb-20 relative dark:bg-lightmidnight'>
                ...
                <div className='container mx-auto sm:px-4 pt-20'>
                    <div className='flex flex-wrap  aos-init aos-animate' data-aos='fade-left' data-aos-delay='300'>
                        ...
                        <div className='container mx-auto py-8'>
                            <h1 className='text-3xl font-bold mb-4'>Welcome to ShareLive Privacy Policy</h1>
                            <p className='mb-8'>
                            ...
                            <h2 className='text-xl font-bold mb-2'>2. Identifying Purposes</h2>
                            <p className='mb-8'>
                            ...
                            <h2 className='text-xl font-bold mb-2'>3. Consent</h2>
                            <p className='mb-8'>
                            ...
                            <h2 className='text-xl font-bold mb-2'>4. Limiting Collection</h2>
                            <p className='mb-8'>
                            ...
                            <h2 className='text-xl font-bold mb-2'>5. Limiting Use, Disclosure and Retention</h2>
                            <p className='mb-8'>
                            ...
                            <h2 className='text-xl font-bold mb-2'>6. Accuracy</h2>
                            <p className='mb-8'>
                            ...
                            <h2 className='text-xl font-bold mb-2'>7. Safeguarding Customer Information</h2>
                            <p className='mb-8'>
                            ...
                            <h2 className='text-xl font-bold mb-2'>8. Openness</h2>
                            <p className='mb-8'>
                            ...
                            <h2 className='text-xl font-bold mb-2'>9. Customer Access
                            </h2>
                            <p className='mb-8'>
                            ...
                            <h2 className='text-xl font-bold mb-2'>10. Handling Customer Complaints and Suggestions </h2>
                            <p className='mb-4'>
                            ...
                            <h3 className='text-lg font-bold mb-2'>Other Websites</h3>
                            <p className='mb-4'>
