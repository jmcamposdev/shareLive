                ...
                <div className='container mx-auto sm:px-4 pt-20'>
                    <div className='flex flex-wrap  aos-init aos-animate' data-aos='fade-left' data-aos-delay='300'>
                        <div className='container mx-auto py-8'>
                            <h1 className='text-5xl text-center	 font-bold mb-4 dark:text-white'>Site Map</h1>
                        </div>
                        <div className='container mx-auto py-8'>
                            ...
                            <h2 className='text-xl font-bold mb-2 dark:text-white'>3. Consent</h2>
                            <p className='mb-8 dark:text-white'>
                            ...
                            <h2 className='text-xl font-bold mb-2 dark:text-white'>4. Limiting Collection</h2>
                            <p className='mb-8 dark:text-white'>
                            ...
                            <h2 className='text-xl font-bold mb-2 dark:text-white'>5. Limiting Use, Disclosure and Retention</h2>
                            <p className='mb-8 dark:text-white'>
                            ...
                            <h2 className='text-xl font-bold mb-2 dark:text-white'>6. Accuracy</h2>
                            <p className='mb-8 dark:text-white'>
                            ...
                            <h2 className='text-xl font-bold mb-2 dark:text-white'>7. Safeguarding Customer Information</h2>
                            <p className='mb-8 dark:text-white'>
                            ...
                            <h2 className='text-xl font-bold mb-2 dark:text-white'>8. Openness</h2>
                            <p className='mb-8 dark:text-white'>
                            ...
                            <h2 className='text-xl font-bold mb-2 dark:text-white'>9. Customer Access
                            </h2>
                            <p className='mb-8 dark:text-white'>
                            ...
                            <h2 className='text-xl font-bold mb-2 dark:text-white'>10. Handling Customer Complaints and Suggestions </h2>
                            ...
                            <h2 className='text-xl font-bold mb-2 dark:text-white'>Additional Information</h2>

                            <h3 className='text-lg font-bold mb-2 dark:text-white'>Cookies</h3>
                            <p className='mb-4 dark:text-white'>
                            ...
                            <h3 className='text-lg font-bold mb-2 dark:text-white'>Other Websites</h3>
                            <p className='mb-4 dark:text-white'>
