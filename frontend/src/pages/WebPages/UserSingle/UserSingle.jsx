                ...
                <div className='agent-single sm:flex items-center'>
                  ...
                  <div className='single-contant ml30 ml0-xs'>
                    ...
                    <div className='agent-meta mb15 md:flex items-center'>
                      ...
                      {user.phone ? (<a className='text fz15 pe-2 ps-2 bdrr1'><i className='flaticon-call pe-1' />{user.phone}</a>) : ''}
                      {user.mobilePhone ? (<a className='text fz15 ps-2'><i className='flaticon-smartphone pe-1' />{user.mobilePhone}</a>) : ''}
                    </div>
              ...
              <div className='flex flex-wrap '>
                <div className='lg:w-full pr-4 pl-4'>
                  <div className='agent-single-details mt30 pb30 bdrb1'>
                    <h6 className='fz17 mb30'>About {user.firstName}</h6>
